...
@section('main-body')
    <form class="form-horizontal" role="form" method="POST" action="/save-service">
        ...
        <div class="form-group row">
            <label class="col-sm-2 control-label" for="service_name">Service Name</label>
            <div class="col-sm-10" data-validate-required="This field is required">
                <input type="text" id="service_name" name="service_name" class="col-xs-10 col-sm-5"
                       value='{{isset($postdata)?$postdata['name']:''}}'/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 control-label" for="service_price">Service Amount</label>
            <div class="col-sm-10"data-validate-required="This field is required" data-validate-number="Must contains number greater than 0">
