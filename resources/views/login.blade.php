...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{DIR_HTTP_CSS}}ace.min.css" />
		<link rel="stylesheet" href="{{DIR_HTTP_CSS}}ace-rtl.min.css" />
		<link rel="stylesheet" href="{{DIR_HTTP_CSS}}login.css" />
	</head>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action='/loginAuth' method='post'>
												...
												@endif
												<input type="text" class="hide" value="{{$back}}" name="backUrl">
												<fieldset>
